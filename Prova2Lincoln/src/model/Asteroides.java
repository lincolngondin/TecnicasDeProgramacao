...
public class Asteroides {
	...
	public Asteroides(int diametroSistema){
		...
		this.posicoesOcupadas[7*diametroSistema + 7] = true;
	}
	...
	public boolean checarPosicao(int x, int y) {
		int pos = y * this.diametroSistema + x;
	...
	public void removerTodosObstaculos() {
		this.bugsEDevs = new ArrayList<Obstaculo>();
		this.qBugs = 0;
		this.qDevs = 0;
		for(int i = 0; i < this.diametroSistema*this.diametroSistema; i++) {
			this.posicoesOcupadas[i] = false;
		}
		this.posicoesOcupadas[7*diametroSistema + 7] = true;
	}
