...
abstract public class Planet extends CorpoCeleste{
	...
	public Planet(int x, int y, int distanciaEstrela, int velocidadeTranslacao, double velocidadeRotacao, String nome, CelestialBodies cb, String descricao) {
		super(x, y, nome, cb, descricao);
	...
	public double getVelocidadeMediaTranslacao() {
		return this.somaDeTodasAsVelocidadesDeTranslacao/this.instantesVivos;
	}
